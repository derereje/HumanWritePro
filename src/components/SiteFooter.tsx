...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/5 bg-background text-slate-400 text-lg">
      {/* Legal Disclaimer */}
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg text-slate-400 leading-relaxed font-medium">
                <strong className="text-blue-400 font-black">AcousticText is not a tool for academic dishonesty or cheating.</strong>{" "}
            ...
            <Link
              ...
              className="text-base font-semibold text-blue-600 hover:text-blue-700 transition-colors whitespace-nowrap underline decoration-blue-200 hover:decoration-blue-400 underline-offset-4"
            >
              Read more →
            </Link>
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:py-14 lg:px-8">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between items-center lg:items-start text-center lg:text-left">
          <div className="max-w-sm space-y-6">
            <Link href="/" className="flex items-center gap-3 group" data-analytics-id="footer-logo">
              <span className="text-2xl font-black tracking-tighter bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent group-hover:from-blue-300 group-hover:to-blue-500 transition-all duration-300">AcousticText</span>
            </Link>
            <p className="text-lg text-slate-400 max-w-md mx-auto lg:mx-0 font-medium">
              AcousticText is the gold standard for undetectable AI content transformation, powered by proprietary human-fidelity algorithms.
            </p>
          </div>

          <div className="grid flex-1 gap-8 grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 w-full sm:w-auto">
            <div>
              <h5 className="text-sm font-black uppercase tracking-[0.2em] text-white/40">Navigate</h5>
              <ul className="mt-4 space-y-3 text-lg text-slate-400">
                <li>
            ...
            <div>
              <h5 className="text-sm font-black uppercase tracking-[0.2em] text-white/40">Resources</h5>
            ...
            <div>
              <h5 className="text-sm font-black uppercase tracking-[0.2em] text-white/40">Stay in touch</h5>
              <ul className="mt-4 space-y-3 text-base text-slate-400">
                <li>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/5 pt-8 text-base text-slate-400 sm:flex-row sm:items-center sm:justify-between font-medium">
          <p>© {new Date().getFullYear()} AcousticText. Premium AI Humanization.</p>
          <p className="text-sm opacity-60">Engineered with Excellence.</p>
        </div>
      </div>
    </footer>
  );
